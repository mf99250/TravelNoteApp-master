...
class FoodViewController: UIViewController ,UITableViewDataSource{
    ...
    var food : [Food] = [Food(image: UIImage(named: "photo")!.pngData()!,name: "",storeName: "",address: "", phoneNumber: "",introduction: "新增")]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.introductionLabel.text = "筆記：\n\(food[indexPath.row].introduction)"
        cell.addressLabel.text = "地點：\(food[indexPath.row].address)"
        return cell
    }
    ...
    @IBAction func addBack(segue: UIStoryboardSegue){
        if let controller = segue.source as? AddFoodViewController, let addFood = controller.addFood{
            ...
            food.insert(Food(image: addFood.image, name: addFood.name,storeName: "", address: "", phoneNumber: "", introduction: "新增"), at: 0)
